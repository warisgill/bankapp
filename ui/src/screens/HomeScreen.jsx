...
import { faArrowRightFromBracket, faBuildingColumns, faMoneyBillTransfer, faCreditCard, faLandmarkFlag} from '@fortawesome/free-solid-svg-icons';
  ...
  const renderDashboard = () => {
    return (
        ...
        <Col md={8} style={{marginTop: '4vh'}}>
          <Card>
            <Card.Header style={{fontSize: '3vh'}} className='bg-dark text-white'>
                <strong>
                  Bank accounts
                </strong>
              </Card.Header>
          ...
          <Card style={{marginTop: '2vh'}}>
            <Card.Header className='bg-light text-uppercase'>
              <strong>
                Cisco Checking <FontAwesomeIcon icon={faArrowRightFromBracket} style={{ marginLeft: '1rem'}}/>
              </strong>
            </Card.Header>
            <Card.Body>
              <Card.Text>
                <Row>
                  ...
                  <Col md={6}>
                    <div style={{fontSize: '1.5vh', marginTop: '1vh'}}>
                      Account Number: <span className='text-primary'>12345678987654321</span> <br />
                    </div>
            ...
            <Card.Footer>
              <Link to="/acc-info" style={{ textDecoration: 'none' }}>
                <Button variant="dark" className="float-end">Account info</Button>
              </Link>
              <Button variant="dark" className="float-end me-2">Transfer money</Button>
            </Card.Footer>
          </Card>
          <Card style={{marginTop: '2vh'}}>
            <Card.Header className='bg-light text-uppercase'>
              <strong>
                Cisco Savings <FontAwesomeIcon icon={faArrowRightFromBracket} style={{ marginLeft: '1rem'}}/>
              </strong>
            </Card.Header>
            <Card.Body>
              <Card.Text>
        ...
        <Col md={3}>
          <Link to="/new-account" style={{ textDecoration: 'none' }}>
            <Card className='custom-card' style={{marginTop: '6vh'}}>
              ...
              <Badge circle bg="dark" className="position-absolute top-0 end-0" style={{transform: 'translate(-20%, -50%)', height: '5vh', width: '5vw'}}>
                <FontAwesomeIcon 
